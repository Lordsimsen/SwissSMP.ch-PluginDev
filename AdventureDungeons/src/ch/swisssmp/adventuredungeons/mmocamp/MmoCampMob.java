...
import ch.swisssmp.adventuredungeons.mmoentity.MmoEntitySaveData;
...
public class MmoCampMob {
	...
	public MmoCampMob(MmoCampSpawnpoint spawnpoint, Integer mmo_camp_mob_id, EntityType entityType, Integer max_count){
		this.mmo_camp_mob_id = mmo_camp_mob_id;
		this.spawnpoint = spawnpoint;
		this.entityType = entityType;
		this.max_count = max_count;
		World world = spawnpoint.camp.world;
		MmoWorldInstance mmoWorldInstance = MmoWorld.getInstance(world);
