...
public class HighscoresLecternSlot extends PickItemSlot {

    private final ZvieriArenaEditor view;

    public HighscoresLecternSlot(ZvieriArenaEditor view, int slot) {
        super(view, slot);
        this.view = view;
    }
    ...
    protected ItemStack createPick() {
        ...
        ItemUtil.setString(itemStack, "zvieritool", "highscores_lectern");
        return itemStack;
    }
