...
import ch.swisssmp.zvieriplausch.editorslots.*;
...
public class ZvieriArenaEditor extends CustomEditorView {
	...
	protected Collection<EditorSlot> initializeEditor() {
		...
		result.add(new StorageChestSlot(this, 6));
		result.add(new ArenaRegionSlot(this, 7, arena));
		result.add(new JukeboxSlot(this, 8));
		result.add(new EntryWaypointSlot(this, 9));
		result.add(new CountersDeleteSlot(this, 14, this.arena));
		result.add(new RecipesLecternSlot(this, 15));
		result.add(new HighscoresLecternSlot(this, 16));
