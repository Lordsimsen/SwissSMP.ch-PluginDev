...
public class JPConfiguration implements IConfiguration {
	...
	public ItemStack getDisplayBorder(){
		return getConfigMaterial("display.border", new ItemStack(Material.BLACK_STAINED_GLASS), 1);
	}
	...
	public ItemStack getDisplayArrowLeft(){
		return getConfigMaterial("display.arrow.left", new ItemStack(Material.CARROT), 1);
	}

	public ItemStack getDisplayUndo(){
		return getConfigMaterial("display.undo", new ItemStack(Material.FLOWER_POT), 1);
	}
