...
public class MmoGolem extends EntityIronGolem implements IControllable{
	
	public MmoEntitySaveData data;
	public MmoAI mmoAI;
	
	public MmoGolem(net.minecraft.server.v1_11_R1.World world){
		super(world);
	}
	
	public MmoGolem(MmoMob template, World world) {
