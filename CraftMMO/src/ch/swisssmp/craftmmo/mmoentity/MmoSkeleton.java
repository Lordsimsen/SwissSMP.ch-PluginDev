...
public class MmoSkeleton extends EntitySkeleton implements IControllable{
	
	public MmoEntitySaveData data;
	public MmoAI mmoAI;
	
	public MmoSkeleton(net.minecraft.server.v1_12_R1.World world){
		super(world);
	}
	
	public MmoSkeleton(MmoMob template, World world) {
