...
public class MmoGuardian extends EntityGuardian implements IControllable{
	
	public MmoEntitySaveData data;
	public MmoAI mmoAI;
	
	public MmoGuardian(net.minecraft.server.v1_11_R1.World world){
		super(world);
	}
	
	public MmoGuardian(MmoMob template, World world) {
