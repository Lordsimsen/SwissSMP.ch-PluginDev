...
public class MmoHuman extends EntityVillager implements IControllable{
	
	public MmoEntitySaveData data;
	public MmoAI mmoAI;
	
	public MmoHuman(net.minecraft.server.v1_12_R1.World world){
		super(world);
	}
	
	public MmoHuman(MmoMob template, World world) {
