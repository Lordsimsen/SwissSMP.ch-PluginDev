...
public class MmoRabbit extends EntityRabbit implements IControllable{
	
	public MmoEntitySaveData data;
	public MmoAI mmoAI;
	
	public MmoRabbit(net.minecraft.server.v1_11_R1.World world){
		super(world);
	}
	
	public MmoRabbit(MmoMob template, World world) {
