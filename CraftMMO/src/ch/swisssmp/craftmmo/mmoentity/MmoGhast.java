...
public class MmoGhast extends EntityGhast implements IControllable{
	
	public MmoEntitySaveData data;
	public MmoAI mmoAI;
	
	public MmoGhast(net.minecraft.server.v1_12_R1.World world){
		super(world);
	}
	
	public MmoGhast(MmoMob template, World world) {
