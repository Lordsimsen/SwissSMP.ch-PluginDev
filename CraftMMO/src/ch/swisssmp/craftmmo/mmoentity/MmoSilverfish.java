...
public class MmoSilverfish extends EntitySilverfish implements IControllable{
	
	public MmoEntitySaveData data;
	public MmoAI mmoAI;
	
	public MmoSilverfish(net.minecraft.server.v1_12_R1.World world){
		super(world);
	}
	
	public MmoSilverfish(MmoMob template, World world) {
