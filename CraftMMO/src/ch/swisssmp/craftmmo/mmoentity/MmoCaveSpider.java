...
public class MmoCaveSpider extends EntityCaveSpider implements IControllable{
	
	public MmoEntitySaveData data;
	public MmoAI mmoAI;
	
	public MmoCaveSpider(net.minecraft.server.v1_12_R1.World world){
		super(world);
	}
	
	public MmoCaveSpider(MmoMob template, World world) {
