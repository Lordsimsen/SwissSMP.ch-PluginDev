...
public class MmoOcelot extends EntityOcelot implements IControllable{
	
	public MmoEntitySaveData data;
	public MmoAI mmoAI;
	
	public MmoOcelot(net.minecraft.server.v1_11_R1.World world){
		super(world);
	}
	
	public MmoOcelot(MmoMob template, World world) {
