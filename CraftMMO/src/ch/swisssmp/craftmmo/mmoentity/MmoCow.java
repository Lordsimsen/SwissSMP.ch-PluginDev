...
public class MmoCow extends EntityCow implements IControllable{
	
	public MmoEntitySaveData data;
	public MmoAI mmoAI;
	
	public MmoCow(net.minecraft.server.v1_11_R1.World world){
		super(world);
	}
	
	public MmoCow(MmoMob template, World world) {
