...
public class MmoHorse extends EntityHorse implements IControllable{
	
	public MmoEntitySaveData data;
	public MmoAI mmoAI;
	
	public MmoHorse(net.minecraft.server.v1_11_R1.World world){
		super(world);
	}
	
	public MmoHorse(MmoMob template, World world) {
