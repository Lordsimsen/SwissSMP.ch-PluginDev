...
public class MmoShulker extends EntityShulker implements IControllable{
	
	public MmoEntitySaveData data;
	public MmoAI mmoAI;
	
	public MmoShulker(net.minecraft.server.v1_11_R1.World world){
		super(world);
	}
	
	public MmoShulker(MmoMob template, World world) {
