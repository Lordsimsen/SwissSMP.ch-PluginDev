...
public class MmoGiant extends EntityGiantZombie implements IControllable{
	
	public MmoEntitySaveData data;
	public MmoAI mmoAI;
	
	public MmoGiant(net.minecraft.server.v1_12_R1.World world){
		super(world);
	}
	
	public MmoGiant(MmoMob template, World world) {
