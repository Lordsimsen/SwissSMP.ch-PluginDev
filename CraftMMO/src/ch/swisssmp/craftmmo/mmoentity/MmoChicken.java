...
public class MmoChicken extends EntityChicken implements IControllable{
	
	public MmoEntitySaveData data;
	public MmoAI mmoAI;
	
	public MmoChicken(net.minecraft.server.v1_11_R1.World world){
		super(world);
	}
	
	public MmoChicken(MmoMob template, World world) {
