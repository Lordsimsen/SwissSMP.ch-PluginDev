...
public class MmoBear extends EntityPolarBear implements IControllable{
	
	public MmoEntitySaveData data;
	public MmoAI mmoAI;
	
	public MmoBear(net.minecraft.server.v1_12_R1.World world){
		super(world);
	}
	
	public MmoBear(MmoMob template, World world) {
