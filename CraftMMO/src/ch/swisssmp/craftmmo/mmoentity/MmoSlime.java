...
public class MmoSlime extends EntitySlime implements IControllable{
	
	public MmoEntitySaveData data;
	public MmoAI mmoAI;
	
	public MmoSlime(net.minecraft.server.v1_12_R1.World world){
		super(world);
	}
	
	public MmoSlime(MmoMob template, World world) {
