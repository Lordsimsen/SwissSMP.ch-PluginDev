...
public class MmoWitch extends EntityWitch implements IControllable{
	
	public MmoEntitySaveData data;
	public MmoAI mmoAI;
	
	public MmoWitch(net.minecraft.server.v1_11_R1.World world){
		super(world);
	}
	
	public MmoWitch(MmoMob template, World world) {
