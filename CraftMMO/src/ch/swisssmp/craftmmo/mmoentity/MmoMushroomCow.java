...
public class MmoMushroomCow extends EntityMushroomCow implements IControllable{
	
	public MmoEntitySaveData data;
	public MmoAI mmoAI;
	
	public MmoMushroomCow(net.minecraft.server.v1_11_R1.World world){
		super(world);
	}
	
	public MmoMushroomCow(MmoMob template, World world) {
