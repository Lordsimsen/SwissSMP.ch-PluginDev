...
public class MmoWolf extends EntityWolf implements IControllable{
	
	public MmoEntitySaveData data;
	public MmoAI mmoAI;
	
	public MmoWolf(net.minecraft.server.v1_11_R1.World world){
		super(world);
	}
	
	public MmoWolf(MmoMob template, World world) {
