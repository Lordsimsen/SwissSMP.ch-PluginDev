...
public class MmoBlaze extends EntityBlaze implements IControllable{
	
	public MmoEntitySaveData data;
	public MmoAI mmoAI;
	
	public MmoBlaze(net.minecraft.server.v1_12_R1.World world){
		super(world);
	}
	
	public MmoBlaze(MmoMob template, World world) {
