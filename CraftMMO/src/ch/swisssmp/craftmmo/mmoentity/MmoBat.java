...
public class MmoBat extends EntityBat implements IControllable{
	
	public MmoEntitySaveData data;
	public MmoAI mmoAI;
	
	public MmoBat(net.minecraft.server.v1_11_R1.World world){
		super(world);
	}
	
	public MmoBat(MmoMob template, World world) {
