...
public class MmoCreeper extends EntityCreeper implements IControllable{
	
	public MmoEntitySaveData data;
	public MmoAI mmoAI;
	
	public MmoCreeper(net.minecraft.server.v1_11_R1.World world){
		super(world);
	}
	
	public MmoCreeper(MmoMob template, World world) {
