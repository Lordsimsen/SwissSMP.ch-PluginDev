...
public class MmoZombie extends EntityZombie implements IControllable{
	
	public MmoEntitySaveData data;
	public MmoAI mmoAI;
	
	public MmoZombie(net.minecraft.server.v1_12_R1.World world){
		super(world);
	}
	
	public MmoZombie(MmoMob template, World world) {
