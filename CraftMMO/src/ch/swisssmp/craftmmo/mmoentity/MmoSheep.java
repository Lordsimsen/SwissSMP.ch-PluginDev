...
public class MmoSheep extends EntitySheep implements IControllable{
	
	public MmoEntitySaveData data;
	public MmoAI mmoAI;
	
	public MmoSheep(net.minecraft.server.v1_12_R1.World world){
		super(world);
	}
	
	public MmoSheep(MmoMob template, World world) {
