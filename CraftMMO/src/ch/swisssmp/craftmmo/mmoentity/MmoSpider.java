...
public class MmoSpider extends EntitySpider implements IControllable{
	
	public MmoEntitySaveData data;
	public MmoAI mmoAI;
	
	public MmoSpider(net.minecraft.server.v1_12_R1.World world){
		super(world);
	}
	
	public MmoSpider(MmoMob template, World world) {
