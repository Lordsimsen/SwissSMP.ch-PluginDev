...
public class MmoSquid extends EntitySquid implements IControllable{
	
	public MmoEntitySaveData data;
	public MmoAI mmoAI;
	
	public MmoSquid(net.minecraft.server.v1_11_R1.World world){
		super(world);
	}
	
	public MmoSquid(MmoMob template, World world) {
