...
public class MmoSnowman extends EntitySnowman implements IControllable{
	
	public MmoEntitySaveData data;
	public MmoAI mmoAI;
	
	public MmoSnowman(net.minecraft.server.v1_11_R1.World world){
		super(world);
	}
	
	public MmoSnowman(MmoMob template, World world) {
