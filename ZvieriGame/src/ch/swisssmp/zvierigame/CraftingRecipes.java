...
public class CraftingRecipes {
    ...
    public static void registerCraftingRecipes(){
        ...
        Bukkit.getLogger().info(ZvieriGamePlugin.getPrefix() + "Added Recipe: Zvieri hot chocolate");

        ItemStack pasta = getTaggedCustomItemStack("PASTA");
        ShapedRecipe pastaRecipe = new ShapedRecipe(new NamespacedKey(ZvieriGamePlugin.getInstance(), "pasta"), pasta);
        pastaRecipe.shape(
                "   ",
                " ww",
                "   "
        ...
        Bukkit.getLogger().info(ZvieriGamePlugin.getPrefix() + "Added Recipe: Pasta");
...
//        Bukkit.getServer().addRecipe(pastaRecipe);
        ...
        ShapedRecipe hashBrownsRecipe = new ShapedRecipe(new NamespacedKey(ZvieriGamePlugin.getInstance(), "hash_browns"), hashBrowns);
...
//        Bukkit.getServer().addRecipe(hashBrownsRecipe);
        ...
        ShapedRecipe meatFeastRecipe = new ShapedRecipe(new NamespacedKey(ZvieriGamePlugin.getInstance(), "meat_feast"), meatFeast);
...
//        Bukkit.getServer().addRecipe(schniPoRecipe);
        ...
        ShapedRecipe veggieRecipe = new ShapedRecipe(new NamespacedKey(ZvieriGamePlugin.getInstance(), "veggies_delight"), veggie);
        veggieRecipe.shape(
                "   ",
                "kwc",
                "   "
...
//        Bukkit.getServer().addRecipe(dameBlancheRecipe);
    ...
    private static ItemStack getTaggedCustomItemStack(String customEnum){
        ...
        Bukkit.getLogger().info(ZvieriGamePlugin.getPrefix() + "Tagged custom item: " + customEnum + " | " + result.toString());
        return result;
    }
    ...
    private static ItemStack getTaggedItemStack(Material material){
        ...
        Bukkit.getLogger().info(ZvieriGamePlugin.getPrefix() + "Tagged: " + material.toString());
        return item;
    }
